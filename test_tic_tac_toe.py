...
class TestTicTacToe(unittest.TestCase):
    ...
    def test_checking_if_board_is_empty(self):
        self.assertFalse(ttt.check_whole_board(self ,[[1,2,3],[4,5,6],[7,8,9]]))

    def test_checking_whole_board_is_empty(self):
        self.assertFalse(ttt.check_whole_board(self,board=[["O",2,3],[4,5,6],[7,8,9]]))

    def test_checking_whole_board_is_empty_or_not(self):
        self.assertTrue(ttt.check_whole_board(self,board=[["O","X","O"],["X","O","X"],["X","O","X"]]))
    ...
    def test_three_inspectingRow(self):
        self.assertEqual(ttt.inspecting_row(self, board_list=[[1, "O", "O"], [4, 5, 6], ["O", "O", "O"]]),"Winner is O")
    ...
    def test_inspectingReversDiag_X(self):
        self.assertEqual(ttt.inspecting_revers_diag(self, board_list=[[1, 2, "X"], [4, "X", 6], ["X", 7, 8]]),
                         "Winner is X")
    ...
    def check_for_result(self):
        self.assertTrue(ttt.check_for_result(self , board_list=[["O","X",3],["X","X","O"],["O","X",9]],cur_player="X"))

    def check_for_result(self):
        self.assertFalse(ttt.check_for_result(self , board_list=[["O","X",3],["X","X","O"],["O","X",9]] ,cur_player="O"))

    def check_for_result(self):
        self.assertTrue(ttt.check_for_result(self , board_list=[[1,"O","X"],[3,"O","X"],[6,7,"X"]],cur_player="X"))

    def check_for_result(self):
        self.assertFalse(ttt.check_for_result(self , board_list=[[1,"O","X"],[3,"O","X"],[6,7,"X"]],cur_player="O"))